...
#define STRING_CONFIG_H_AUTHOR "JUAN CASIAN" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JUANBOT"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 295.0 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 170.00 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 135.0 //mm  Get this value from auto calibrate
 ...
 * Stepper Drivers
 *
 * These settings allow Marlin to tune stepper driver timing and eFnable advanced options for
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER -4.0   // Y offset: -front +behind [the nozzle]
